...
public class ViewBusinessInfoOwner {
	...
	private static void init_component_viewBusinessInfo() {
		if(FlexiBookApplication.getflexibook() != null) {
			if(FlexiBookApplication.getflexibook().getBusiness() == null) {
				Business b = new Business("Please set-up the name of the business", "Please set-up the address of the business", 
						"Please set-up the phone number of the business", "Please set-up the email of the business", FlexiBookApplication.getflexibook());
			}
		}
		...
		edit.setText("Edit");
		edit.setBounds(550, 100, 80, 25);
		edit.addActionListener(new java.awt.event.ActionListener() {
			public void actionPerformed(java.awt.event.ActionEvent evt) {
				editActionPerformed(evt);
			}
		});
		panelViewBusiness.add(edit);
		...
		nameCur.setBounds(200, 150, 300, 25);
		...
		addressCur.setBounds(200, 200, 300, 25);
		...
		emailCur.setBounds(200, 300, 300, 25);
